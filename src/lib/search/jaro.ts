// Pure Jaro-Winkler similarity (0..1). Used to re-rank FTS candidates by
// how close their name is to what the owner actually typed; also the
// fuzzy-name scorer for Phase 9 dedupe.
...
/** Winkler prefix boost: common 4-char prefix pulls similar names up. */
