// Brand glyphs (LinkedIn, GitHub, X) as inline SVGs — lucide dropped its
// deprecated brand set, and these three are the platforms contact_socials
// actually stores. Sized/stroked to sit beside lucide icons.
